            ...
            SecurityKeyIdentifierClause keyIdentifierClause)
        {
            ...
            if (!MatchesKeyIdentifierClause(keyIdentifierClause))
            {
                throw new InvalidOperationException(
                    $"This '{GetType()}' security token does not support resolving '{keyIdentifierClause}' key identifier clause.");
            }
            ...
            {
                throw new InvalidOperationException(
                    $"This '{GetType()}' security token does not have any keys that can be resolved.");
            }
    ...
    public class X509SecurityToken : SecurityToken, IDisposable
    {
        ...
        public override ReadOnlyCollection<SecurityKey> SecurityKeys
        {
            get
            {
                ...
                if (keys == null)
                {
                    keys = new ReadOnlyCollection<SecurityKey>(new SecurityKey[]
