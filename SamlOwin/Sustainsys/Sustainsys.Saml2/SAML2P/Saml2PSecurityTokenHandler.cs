...
namespace Sustainsys.Saml2.Saml2P
{
    ...
    public class Saml2PSecurityTokenHandler : Saml2SecurityTokenHandler
    {
        ...
        // is fixed.
        protected override void ValidateTokenReplay(DateTime? expirationTime, string securityToken,
        ...
        protected override void ProcessAuthenticationStatement(Saml2AuthenticationStatement statement,
            ClaimsIdentity subject, string issuer)
        {
                    ...
                    subject.AddClaim(
                        new Claim(
                            ...
                            DelimitedString.Join(
                                ...
                                nameIdClaim.Properties.GetValueOrEmpty(
        ...
        protected override Saml2SecurityToken ValidateSignature(string token,
            TokenValidationParameters validationParameters)
        {
