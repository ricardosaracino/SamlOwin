...
namespace Sustainsys.Saml2.Metadata
{
    ...
    {
        public IndexedCollectionWithDefault<ArtifactResolutionService> ArtifactResolutionServices { get; private set; }
            = new IndexedCollectionWithDefault<ArtifactResolutionService>();
