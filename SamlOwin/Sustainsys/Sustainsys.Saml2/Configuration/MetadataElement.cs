...
namespace Sustainsys.Saml2.Configuration
{
    ...
    public class MetadataElement : ConfigurationElement
    {
        ...
        {
            get { return (XsdDuration) base[cacheDuration]; }
        }
        ...
        {
            get { return (TimeSpan?) base[validDuration]; }
        }
        ...
        {
            get { return (ContactPersonsCollection) base[""]; }
        }
        ...
        {
            get { return (bool) base[wantAssertionsSigned]; }
            internal set { base[wantAssertionsSigned] = value; }
        }
    }
}