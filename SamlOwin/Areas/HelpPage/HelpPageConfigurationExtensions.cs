...
using SamlOwin.Areas.HelpPage.ModelDescriptions;
using SamlOwin.Areas.HelpPage.Models;

namespace SamlOwin.Areas.HelpPage
{
    public static class HelpPageConfigurationExtensions
    {
        ...
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", Justification =
            "The exception is recorded as ErrorMessages.")]
